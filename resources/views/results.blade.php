    ...
    <div class="row">
      <div class="col-xs-12" id="breadcrumbs">
        ...
        <div id="metaDescriptionData" hidden="">
          pirkite internetu Schrack Technik » Pristatymas per 24 valandas • galimybė atsiimti vietoje • profesionalus patarimas • Visa informacija!
        </div>
        <ul
          id="breadcrumb_block"
          property="breadcrumb"
          ...
          <li class="home">
            <a
              ...
              class="clickable_breadcrumb_link">Pagrindinis</a>
          </li>
          <li class="search last">
            <strong>Paieškos rezultatai '{{ $query}}'</strong>
          </li>
          <ul></ul>
        </ul>
      </div>
      <div id="content" class="col-xs-12 main-content lower_main_content">
        ...
        <style>
          ...
          .logstics-icon-new {
            background: url(https://www.schrack.com/shop/skin/frontend/schrack/default/schrackdesign/Public/Images/rwd/logistics.png) left top no-repeat;
            width: 25px;
            height: 12px;
            display: inline-block;
            margin-right: 5px;
                      ...
                      <div
                        ...
                        <div class="tabSection posRel">
                          <span
                            ...
                            onclick="jQuery(&#39;#filterMenu&#39;).click(); return false;"></span>
                          <!-- Filter tabs -->
                                  ...
                                  <div id="facet-{{ $attribute->id }}" class="panel-collapse collapse" role="tabpanel">
                                    <div class="panel-body">
                                      <a href="#" onclick="performFilterSearchAjax(this, 'showall'); return false;" class="filter-deselect hide" style="font-size: 0.9em; color: #174573;">
                                        ...
                                        <span style="margin-left: 19px">Atšaukti pasirinkimą</span>
                                      </a>
                                      <ul>
                      ...
                      <div class="row prodListHd">
                        <div
                          ...
                          <select
                            ...
                            <option value="score">Geriausias atitikmuo</option>
                            <option value="name">Abėcėlės tvarka</option>
                          </select>

                          <a id="grid_button" class="gridViewBttn blueTxt"><span class="glyphicon glyphicon-th"></span></a>
                          <a id="list_button" class="listViewBttn"><span class="glyphicon glyphicon-th-list"></span></a>
                          <a
                            id="listcompact_button"
                            class="compactlistViewBttn"><span class="glyphicon glyphicon-list"></span></a>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                          <h3 class="search">Produktai pagal: '{{$query}}'</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <li
                          ...
                          <div class="image_sku_container">
                            ...
                            <div class="imgCont" style="">
                              <span class="sale_mark sale-btn hidden"></span><a
                                class="print-hide p-img previewImageHover track_product_click"><img
                                  class="lazy loaded"
                                  alt="HSEMRJ6GS2"
                                  style="max-width: 200px;"
                                  src="{{$product->photo }}"
                                  data-was-processed="true" /></a><img
                                class="print-only"
                                src="{{$product->photo }}"
                                alt="HSEMRJ6GS2" />
                            </div>
                          </div>
                          <span class="hide-on-print p-name"><a
                              id="textLink_HSEMRJ6GS2"
                              href="#"
                              title=""
                              data-sku="HSEMRJ6GS2"
                              data-brand="Schrack"
                              class="searchtresult_productdetail_link track_product_click">{{$product->name}}</a></span>
                          ...
                          <div
                            class="glyphicon glyphicon-chevron-down detail-expand"></div>
                          <div class="stock-section">
                            <div class="pc-store product-store">
                              <div class="logistics-icon-text-row">
                                <span class="logistic-icon"></span><span class="logstics-icon-text"><span class="nds-time sucubus">per 1 dieną</span>
                                  <span class="nds-qty">{{ random_int(100, 1000) }} vnt</span>
                                  <span class="nds-delivery">pristatoma</span>
                                </span>
                              </div>
                              <div
                                class="cut_off_time_text hide-on-print"></div>
                              <div class="cartInfoHide pickup-icon-text-row">
                                <span class="store-icon-new"></span><span class="formatted-pickup-qty-sum">0 vnt
                                  <span class="pickup-sum-stores-txt">Σ visos parduotuvės</span></span>
                              </div>
                              <div class="product_stock_container">
                                ...
                                <div
                                  ...
                                  <ul>
                                    <li class="hd">
                                      Paruošta siuntimui<span></span>
                                    </li>
                                    <li>
                                      <span class="nds-time">per 1 dieną :</span><span class="nds-qty">984 vnt</span>
                                    </li>
                                    <li class="info_button_pickup_info hd">
                                      Paruošta atsiėmimui<span></span>
                                    </li>
                                  </ul>
                                </div>
                              </div>
